...
export default function ResultView({ acceptedLocations, onRestart }) {
  ...
  const handleExecuteRoute = (mapsQuery) => {
    window.open(
    ...
    >
      ...
      <motion.div variants={cardVariants} style={{ textAlign: 'center' }}>
        ...
        <h2 className="text-headline" style={{ marginTop: '6px' }}>
          {isDesperation ? 'Protocol Failed' : 'The Verdict'}
        </h2>
        {!isDesperation && (
          <p
            style={{
          ...
          >
            Your optimal destination{topLocations.length > 1 ? 's' : ''}
          </p>
        )}
      </motion.div>
          ...
          {topLocations.length > 0 && (
            ...
            >
              ...
              <div style={{ padding: '16px' }}>
                <motion.button
                  whileTap={{ scale: 0.96 }}
                  onClick={() => handleExecuteRoute(topLocations[0].mapsQuery)}
          ...
          {topLocations.slice(1).map((loc, index) => (
            ...
            >
              ...
              >
                ...
                <motion.button
                  whileTap={{ scale: 0.96 }}
                  onClick={() => handleExecuteRoute(loc.mapsQuery)}
